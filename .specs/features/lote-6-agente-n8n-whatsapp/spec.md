...
> Atualizado 2026-08-09 ao fechar o lote (AD-015 reduziu o escopo do smoke conversacional — ver `STATE.md`); **AGT-04, AGT-05 e LGPD-03 reatualizados em 2026-09-09 pelo lote-10**, que fechou a AD-015 (agora `superseded by AD-027`) com a prova conversacional que faltava. "Verified" exige evidência citável (teste unitário, execução MCP, ou execução real); onde só existe evidência parcial/estrutural, isso está dito explicitamente — nunca "Verified" sem citação.
...
| AGT-04 | P1: Agendamento Calendar+Meet | T10 | ✅ **Verified (2026-09-09, lote-10 T13)** — fechado por conversa real: lead `d0aee73c-72e2-468e-bb6b-920e3b88bf17`, `status = qualificado_agendado`, evento no Google Calendar com link de entrada do Meet (`https://meet.google.com/bsy-htxg-evt`). Execuções `2123`,`2128`,`2135`,`2142`,`2143` (`n8n/smoke/evidencia.md` §14). O gap de deferimento da AD-015 (histórica; a AD-015 agora é `superseded by AD-027`) está fechado |
| AGT-05 | P1: Escalonamento | T10 | ✅ **Verified (2026-09-09, lote-10 T14)** — fechado por conversa real: lead `3c9ce0fe-6b7c-439f-9912-eced234d018f`, `status = escalado_humano` com `escalationReason` gravado e responsável atribuído (André Luiz Martins, rede de segurança da AD-022), mensagem seguinte registrada sem nenhuma resposta do agente (rota `somente-registrar`). Execuções `2190`,`2195`,`2200`,`2206` (`n8n/smoke/evidencia.md` §15). O gap de deferimento da AD-015 (histórica; a AD-015 agora é `superseded by AD-027`) está fechado |
...
| LGPD-03 | P1: Opt-out ponta a ponta | T6,T11 | ✅ **Verified (2026-09-09, lote-10 T15)** — o desfecho ponta a ponta que faltava foi provado por conversa real: lead `81509a2c-83ca-4bcc-8f3c-60aba7ffe374`, `optedOutAt = 2026-09-09T12:46:14.541Z`, sessão de memória purgada pelo próprio fluxo (não por limpeza manual), silêncio depois. Execuções `2229`,`2234`,`2239`,`2243` (`n8n/smoke/evidencia.md` §16). Cobertura por palavra-chave exata continua provada em camadas (evidência original desta linha, preservada acima); o lote-10 acrescentou orientação em linguagem natural sobre a mesma detecção determinística (SPEC_DEVIATION registrado, commit `585633a` — `gate.mjs` não mudou uma linha) |

**Coverage:** 12 total, 12 mapped to tasks (T1–T13), 0 unmapped. **10 Verified, 1 Verified-parcial-camada-única (AGT-02), 1 Parcial (AGT-07)** — AGT-04, AGT-05 e LGPD-03 (ponta a ponta) fechados pelo lote-10 em 2026-09-09; ver a AD-015 (histórica, `superseded by AD-027`) para o porquê do deferimento original e a AD-027 para o protocolo que os fechou.
