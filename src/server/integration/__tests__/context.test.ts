    ...
    await db.insert(documents).values([
      {
        ...
        storageKey: `test/${tenantId}/${docNovoId}`,
        storageEtag: `test-etag-${docNovoId}`,
        contentSha256: `${docNovoId.replaceAll("-", "")}${docNovoId.replaceAll("-", "")}`,
        status: "pronto",
        categoryId,
        expiresAt: null,
      },
      {
        ...
        sizeBytes: BigInt(1000),
        storageProvider: "test",
        storageKey: `test/${tenantId}/${docUsadoId}`,
        storageEtag: `test-etag-${docUsadoId}`,
        contentSha256: `${docUsadoId.replaceAll("-", "")}${docUsadoId.replaceAll("-", "")}`,
        status: "pronto",
        categoryId: null,
        expiresAt: null,
      },
      {
        ...
        sizeBytes: BigInt(1000),
        storageProvider: "test",
        storageKey: `test/${tenantId}/${docAmbosId}`,
        storageEtag: `test-etag-${docAmbosId}`,
        contentSha256: `${docAmbosId.replaceAll("-", "")}${docAmbosId.replaceAll("-", "")}`,
        status: "pronto",
        categoryId: null,
      ...
      },
      {
        ...
        sizeBytes: BigInt(1000),
        storageProvider: "test",
        storageKey: `test/${tenantId}/${docExpiradoId}`,
        storageEtag: `test-etag-${docExpiradoId}`,
        contentSha256: `${docExpiradoId.replaceAll("-", "")}${docExpiradoId.replaceAll("-", "")}`,
        status: "pronto",
        categoryId: null,
